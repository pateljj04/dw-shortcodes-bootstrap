...
DesignWall Shortcodes allow easy implementation of Wordpress shortcodes coming along with responsive and the twitter bootstrap. 

== Description ==

DesignWall Shortcodes allow quick and easy implementation of Wordpress shortcodes by the rich-editor for TinyMCE coming along with responsive feature and the sleek twitter bootstrap style.
